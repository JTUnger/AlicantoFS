...
def aruco_precision_landing(vehicle, id_aruco = 72, size_aruco_cm = 19, max_landing_attempts = 2, start_height = 8, safety_height = 15):
...
def loiter_aruco(vehicle, loiterAltitude):
    """Vehicle loiters at loiterAltitude, over the aruco marker"""
    pass